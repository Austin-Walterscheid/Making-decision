...
if (amysBirthYear === brittanisBirthYear) {
  console.log(`Amy and Britany were born in the same year`)
} else {
...
if (temperature > 55 && rain) {
  console.log(`one should wear a t-shirt and carry and umbrella`)
  ...
  console.log(`we will not be getting wet`)
}
////////// PROBLEM 5 //////////
